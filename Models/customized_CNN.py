...
history = model.fit_generator(generator=my_training_batch_generator, steps_per_epoch =int(50244 // batch_size), epochs=6)


model.save('/home/kiyanoushs/KiyanoushCodes/NeedleInsertion/Models/Customized_CNN.h5')
intermediate_layer_model.save('/home/kiyanoushs/KiyanoushCodes/NeedleInsertion/Models/CustomizedCNN_intermediate_layer.h5')
